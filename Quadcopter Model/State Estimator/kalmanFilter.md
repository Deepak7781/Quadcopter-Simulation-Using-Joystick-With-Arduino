...
## Every Element Explained - Parameters and How to Get Them

KF has 5 key parameters. Some known, others tuned.
...
|R (Measured Noise Covariance)|Sensor error (pxp)|- Measure: Sensor datasheet (e.g., GPS $\pm 5$ →25) - Estimate: Stats on known static tests (var of repeated reads). - Adaptive: Online via innovation variance| Accelerometer: R from calibration|
